...
{
    public class ControleurClient : MarshalByRefObject, Interface.InterfaceClient
    {
         ...
         public ControleurClient()
        {
         ...
         public bool EnregistrerClient(string nodossier, string nom, string prenom, string adresse, string telephone, string nif)
         {
