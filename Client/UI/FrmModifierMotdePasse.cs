...
namespace UI
{
    public partial class FrmModifierMotdePasse : Form
    {
        ...
        public string pseud;
        public FrmModifierMotdePasse(Interface.InterfaceUtilisateur ctc)
        {
            InitializeComponent();
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    ctu.retracerutilisateur(numOp, codetrans, ctu.retournerPseudo(), "Modifier mot de passe", DateTime.Now.ToString());
                                    ctt.EnregistrerTransaction(codetrans, ctu.retournerPseudo(), "Modifier mot de passe", DateTime.Now.ToString());
                                    txtAncien.Text = "";
                                    txtNouveau.Text = "";
                                    txtConfirmer.Text = "";
                                    this.Close();
