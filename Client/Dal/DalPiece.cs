...
namespace Dal
{
    public class DalPiece
    {
        ...
        public static string AjouterPiece(Pieces piece)
        {
        ...
        public  static string supprimerPiece(string codepiece)
        {
        ...
        public static  string ModifierStockPiece(string codepiece, int qte,double prix,string nompiece )
        {
            ...
            {
                message = "modification  echouee" + ex.Message;
        ...
        public static string ModifierQuantitePiece(string codepiece, double qte)
        {
